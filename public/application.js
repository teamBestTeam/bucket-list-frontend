...
var onSignUpSubmit = function onSignUpSubmit(event) {
  ...
  api.signUpUser(data).then(function () {
    return api.signInUser(data);
  }).then(ui.onSignInSuccess).then(itemEvents.onIndexItems).catch(ui.onSignUpFailure);
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <div class=\"card\" data-id=\""
    ...
    + "</h3>\n          <button class=\"btn btn-warning\" id=\"updateItemButton\">Edit</button>\n          <button class=\"btn btn-danger\" id=\"deletItemButton\">Delete</button>\n          <iframe\n            src=\"https://platform.twitter.com/widgets/tweet_button.html?size=l&url=https://teambestteam.github.io/bucket-list-frontend&text=I just checked off "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + " from my bucketlist!&hashtags=buckets,lists,bucketlist,listbuckets\"\n            width=\"140\"\n            height=\"37\"\n            title=\"Twitter Tweet Button\"\n            class=\"tweet-class\">\n          </iframe>\n      </div>\n    </div>\n";
